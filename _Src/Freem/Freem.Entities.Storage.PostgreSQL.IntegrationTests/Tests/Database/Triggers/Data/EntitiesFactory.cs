...
namespace Freem.Entities.Storage.PostgreSQL.IntegrationTests.Tests.Database.Triggers.Data;

internal sealed class EntitiesFactory
{
    private readonly Fixture _fixture;

    public UserEntity User { get; }

    private EntitiesFactory(string userId)
    {
    ...
    public static EntitiesFactory CreateFirstUserEntitiesFactory() => new("user1");
    public static EntitiesFactory CreateSecondUserEntitiesFactory() => new("user2");
}