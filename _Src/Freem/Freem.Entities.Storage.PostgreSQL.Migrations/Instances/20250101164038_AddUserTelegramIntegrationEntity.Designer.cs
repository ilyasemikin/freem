...
namespace Freem.Entities.Storage.PostgreSQL.Migrations.Instances
{
    ...
    [Migration("20250101164038_AddUserTelegramIntegrationEntity")]
    partial class AddUserTelegramIntegrationEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Freem.Entities.Storage.PostgreSQL.Database.Entities.EventEntity", b =>
                {
                    ...
                    b.ToTable("events", "core_entities", t =>
                        {
                            t.HasCheckConstraint("events_entity_name_check", "entity_name = 'activity' and (action = 'created' or action = 'updated' or action = 'removed' or action = 'archived' or action = 'unarchived') or entity_name = 'record' and (action = 'created' or action = 'updated' or action = 'removed') or entity_name = 'running_record' and (action = 'started' or action = 'stopped' or action = 'updated' or action = 'removed') or entity_name = 'tag' and (action = 'created' or action = 'updated' or action = 'removed') or entity_name = 'user' and (action = 'registered' or action = 'password_credentials_changed' or action = 'telegram_integration_changed' or action = 'signed_in')");
                        });
                });
