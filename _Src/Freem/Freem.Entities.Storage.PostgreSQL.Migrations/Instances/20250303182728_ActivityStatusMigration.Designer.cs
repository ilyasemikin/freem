...
namespace Freem.Entities.Storage.PostgreSQL.Migrations.Instances
{
    ...
    [Migration("20250303182728_ActivityStatusMigration")]
    partial class ActivityStatusMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Freem.Entities.Storage.PostgreSQL.Database.Entities.EventEntity", b =>
                {
                    ...
                    b.ToTable("events", "core_entities", t =>
                        {
                            t.HasCheckConstraint("events_entity_name_check", "entity_name = 'activity' and (action = 'created' or action = 'updated' or action = 'removed' or action = 'archived' or action = 'unarchived') or entity_name = 'record' and (action = 'created' or action = 'updated' or action = 'removed') or entity_name = 'running_record' and (action = 'started' or action = 'stopped' or action = 'updated' or action = 'removed') or entity_name = 'tag' and (action = 'created' or action = 'updated' or action = 'removed') or entity_name = 'user' and (action = 'registered' or action = 'signed_in' or action = 'settings_changed' or action = 'password_credentials_changed' or action = 'telegram_integration_changed')");
                        });
                });
            ...
            modelBuilder.Entity("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserSettingsEntity", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text")
                        .HasColumnName("user_id");
                    ...
                    b.Property<long>("UtcOffsetTicks")
                        ...
                        .HasColumnName("utc_offset_ticks");

                    b.HasKey("UserId")
                        .HasName("user_settings_pk");

                    b.ToTable("user_settings", "core_entities");
                });

            modelBuilder.Entity("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserTelegramIntegrationEntity", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text")
                        .HasColumnName("user_id")
                    ...
                    b.HasKey("UserId")
                        .HasName("user_telegram_integrations_pk");

                    b.HasIndex("TelegramUserId")
                        .IsUnique()
                        .HasDatabaseName("user_telegram_integrations_telegram_user_id_unique");

                    b.ToTable("user_telegram_integrations", "core_entities");
                });
            ...
            modelBuilder.Entity("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserSettingsEntity", b =>
                {
                    b.HasOne("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserEntity", "User")
                        .WithOne("Settings")
                        .HasForeignKey("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserSettingsEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("user_settings_users_fk");
            ...
            modelBuilder.Entity("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserTelegramIntegrationEntity", b =>
                {
                    b.HasOne("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserEntity", "User")
                        .WithOne("TelegramIntegration")
                        .HasForeignKey("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserTelegramIntegrationEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("user_telegram_integrations_users_fk");
            ...
            modelBuilder.Entity("Freem.Entities.Storage.PostgreSQL.Database.Entities.UserEntity", b =>
                {
                    ...
                    b.Navigation("TelegramIntegration");
                });
