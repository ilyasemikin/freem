...
public sealed class GetRunningRecordTests : RunningRecordTestBase
{
    public GetRunningRecordTests(TestContext context, ITestOutputHelper? output = null) 
        : base(context, output)
    {
    ...
    {
        var response = await Context.Client.Records.GetRunningAsync();
